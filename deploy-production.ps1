...
for file in .gitignore about.php index.php insurance.php plans.php privacy.php send-repair.php shop.php support.php terms.php webhook.php tablet-masters.code-workspace; do
  if [ -f "$file" ]; then
    chmod 644 "$file"
  fi
done
